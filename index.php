						...
						<div class="col-md-12">
							...
							<div class="splash-text">
								...
								<h1 class="splash-headline">SPACEPORT
									<span class="text-primary"> America</span> 2021
								</h1>
								<div class="splash-description">
									<p>
										<span class="text-primary">22 - 26 June, 2021</span>
														...
														<div class="grid">
															<div class="text-grid">
																<h2 class="section-title">
																	<span data-shadow-text="Who are we?">Who are we?</span>
																</h2>
									...
									<div>
										<div class="sponsor-img">
											<a href="https://www.sheffield.ac.uk/acse" target="_blank">
												<img src="demo/clients/1.png" alt="ACSE">
											</a>
										</div>
									...
									<div>
										<div class="sponsor-img">
											<a href="https://shdcomposites.com/" target="_blank">
												<img src="demo/clients/5.svg" alt="SHD COMPOSITES" style="width:100%;height:auto;">
											</a>
										</div>
