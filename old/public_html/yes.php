    ...
    <div class="site-wrapper">
    		...
    		<div class="site-body">
                <section id="progress" class="section">    
					...
					<div class="row">
						        <div class="col ">
                                        <div class="progress-bar progress-bar-striped progress-bar-animated "  role="progressbar" style="height:95%;width:30%;background-color:red;"   >
                                            <span style="font-size:21px;"><b>30%</b></span>
                                        </div>
                            ...
                            <div class="row">
						        <div class="col-s ">
                                    <figure class="scene" style="background-color:white;">
                                        ...
                                        $value = '5' ;       //only use 0 to 100 and dont use "%"
                                        ...
                                        $value = '60' ;       //only use 0 to 100 and dont use "%"
